...
$(document).ready(function(){
	...
	$('#btn_iniciar_jogo').click(function(){
		...
		//exibindo apelidoas dos jogadoreas
	...
	$('.jogada').click(function(){
		var id_campo_clicked = this.id;
		$('#'+id_campo_clicked).off();
		jogada(id_campo_clicked);
	});
	...
	function ganhador(pontos) {
		if(pontos == -3){
			...
			alert('Jogador '+  jogada_1 +' é o vencedor');
			$('.jogada').off();
			
		}
		if(pontos== 3){
			var jogada_2 = $('#entrada_apelido_jogador_2').val();
			alert('Jogador '+  jogada_2 +' é o vencedor');
			$('.jogada').off();
