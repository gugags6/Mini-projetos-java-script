var timerId = null;//variavel que armazena chamada da funcao timeout
...
function game_over(){
	...
	alert('GAME OVER! You didnt pop all baloons at time');
}
...
function situacao_jogo(baloes_inteiros){
	...
	if (baloes_inteiros == 0){
		alert('CONGRATULTIONS!!!YOU GOT POP ALL BALOONS AT TIME');
		parar_jogo();
	}
